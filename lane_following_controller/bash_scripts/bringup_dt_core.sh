...
docker run \
 ...
 -v /home/duckie/vnc-docker/user_code_mount_dir/project/lane_following_controller/config/default_control.yaml:/code/catkin_ws/src/dt-core/packages/lane_control/config/lane_controller_node/default.yaml \
